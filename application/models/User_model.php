...
class User_model extends MY_Model
{
    ...
    public function checkLogin($data)
    {
        ...
        $student_login_raw = !empty($resultdata->student_login) ? json_decode($resultdata->student_login) : null;
        $student_login = is_array($student_login_raw) ? $student_login_raw : array();
        $parent_login_raw = !empty($resultdata->parent_login) ? json_decode($resultdata->parent_login) : null;
